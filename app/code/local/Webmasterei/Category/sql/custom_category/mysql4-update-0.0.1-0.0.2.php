 ...
 */
$installer->updateAttribute('catalog_category', 'social_image',  array(
...
$installer->updateAttribute('catalog_category', 'cannonical_url',  array(
 ...
 * with yours.
 */
$installer->updateAttributeToGroup(
    $entityTypeId,
    $attributeSetId,
    $attributeGroupId,
    'social_image',
